...
public class App 
{
    ...
    static final String STUDENT_NAME = "Pablo Postigo Morales";
    ...
    public static void main( String[] args )
    {
        ...
        var clients = (new ClientDAO(HibernateUtil.getSessionFactory())).getAll();
        ...
        (new CarDAO(HibernateUtil.getSessionFactory())).save(car);

        // Show clients again with their cars. We can see the new car added
        clients = (new ClientDAO(HibernateUtil.getSessionFactory())).getAll();
